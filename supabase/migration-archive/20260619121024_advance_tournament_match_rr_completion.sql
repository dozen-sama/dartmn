...
-- Original version: 20260619121024
-- Original name: advance_tournament_match_rr_completion
...
BEGIN
  ...
  IF v_bracket = 'round_robin' THEN
    ...
    END IF;
  ELSE
    -- SE/DE: winners bracket-ийн финал (next_match_id null) дуусвал тэмцээн дуусна
