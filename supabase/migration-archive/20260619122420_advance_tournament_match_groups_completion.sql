...
-- Original version: 20260619122420
-- Original name: advance_tournament_match_groups_completion
...
BEGIN
  ...
  IF v_bracket = 'round_robin' THEN
    ...
    END IF;
  ELSE
    -- SE/DE/groups: дэвших заагчгүй (next_match_id null), losers бус, бүлгийн бус
    -- match = финал. group_no NOT NULL нь бүлгийн RR match тул дуусгахгүй.
