...
export const TIERS: TierInfo[] = [
  { tier: "Залуу",   min: 0,    max: 999,  color: "text-slate-400",   bg: "bg-slate-400/15",   border: "border-slate-400/30",   icon: "", nextMin: 1000, description: "Шинэхэн тоглогч" },
  { tier: "Начин",   min: 1000, max: 1199, color: "text-sky-400",     bg: "bg-sky-400/15",     border: "border-sky-400/30",     icon: "", nextMin: 1200, description: "Хурдан, оновчтой" },
  { tier: "Харцага", min: 1200, max: 1399, color: "text-emerald-400", bg: "bg-emerald-400/15", border: "border-emerald-400/30", icon: "", nextMin: 1400, description: "Хурц нүдтэй" },
  { tier: "Заан",    min: 1400, max: 1599, color: "text-amber-500",   bg: "bg-amber-500/15",   border: "border-amber-500/30",   icon: "", nextMin: 1600, description: "Хүчтэй, тогтвортой" },
  { tier: "Гарьд",   min: 1600, max: 1799, color: "text-orange-400",  bg: "bg-orange-400/15",  border: "border-orange-400/30",  icon: "", nextMin: 1800, description: "Домгийн шувуу" },
  { tier: "Арслан",  min: 1800, max: 2099, color: "text-red-400",     bg: "bg-red-400/15",     border: "border-red-400/30",     icon: "", nextMin: 2100, description: "Хаан зэргийн тоглогч" },
  { tier: "Дархан",  min: 2100, max: 9999, color: "text-yellow-400",  bg: "bg-yellow-400/15",  border: "border-yellow-400/30",  icon: "", nextMin: null, description: "Дархан мэргэн" },
]
